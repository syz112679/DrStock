...
public class StockKLineChart_1yearFragment extends android.support.v4.app.Fragment implements  View.OnClickListener  {
...
//                        " 涨跌幅" + changePercentage);
    ...
    private void loadChartCHNData() {
        ...
        candleEntries = Model.getCHNCandleEntries_1year();
        ...
        /*ma5*/
        List<Entry> ma5Entries = Model.getMa5CHNEntries_1year();
        /*ma10*/
        List<Entry> ma10Entries = Model.getMa10CHNEntries_1year();
        /*ma20*/
        List<Entry> ma20Entries = Model.getMa20CHNEntries_1year();
...
//                rsiChart, mChart));
    ...
    //render us stock k line chart
    private void loadChartUSData() {
        mChart.resetTracking();

        candleEntries = Model.getUSCandleEntries_1year();
...
//                rsiChart, mChart));
    ...
    private void loadChartData() {
        ...
        candleEntries = Model.getCandleEntries_1year();
        ...
        xVals = new ArrayList<>();
        for (int i = DateInfo.size()-246; i < DateInfo.size(); i++) {
            xVals.add(DateInfo.get(i));
        }
        ...
        /*ma10*/
        List<Entry> ma10Entries = Model.getMa10Entries_1year();
        /*ma20*/
        List<Entry> ma20Entries = Model.getMa20Entries_1year();
        /*ma50*/
        List<Entry> ma50Entries = Model.getMa50Entries_1year();
...
//                barChart.setHighlightValue(new Highlight(h.getXIndex(), 0));
    ...
    private void loadChartData_Rsi6(){
        ...
        List<Entry> lineEntries = Model.getRsi6Entries_1year();
...
//        List<String> DateInfo = Model.getDate();
    ...
    private void loadChartData_Rsi12(){
        rsiChart.resetTracking();
        List<Entry> lineEntries = Model.getRsi12Entries_1year();
...
//        List<String> DateInfo = Model.getDate();
    ...
    private void loadChartData_Rsi24(){
        rsiChart.resetTracking();
        List<Entry> lineEntries = Model.getRsi24Entries_1year();
...
//        List<String> DateInfo = Model.getDate();
    ...
    private void loadChartData_Rsi10(){
        rsiChart.resetTracking();
        List<Entry> lineEntries = Model.getRsi10Entries_1year();
...
//        List<String> DateInfo = Model.getDate();
    ...
    private void loadChartData_Rsi14(){
        rsiChart.resetTracking();
        List<Entry> lineEntries = Model.getRsi14Entries_1year();
...
//        List<String> DateInfo = Model.getDate();
    ...
    private void loadChartData_Rsi20(){
        rsiChart.resetTracking();
        List<Entry> lineEntries = Model.getRsi20Entries_1year();
